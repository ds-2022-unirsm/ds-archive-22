var w, h;
var quanti = 5; // vertici
var c = []; // array vuoto che contiene gli elementi (camminatori)
var speedMax = 0.02; // velocità movimento

function setup() {
  createCanvas((w = windowWidth), (h = windowHeight));
  strokeWeight(10); // spessore linea
...
function draw() {
  background(0, 1); // trasparenza 10 per fare fade
...
function Camminatore(_id) {
  ...
  this.tx = random(800); // valore random che rappresenta delta/incremento
  this.ty = random(50); // valore random che rappresenta delta/incremento
